...
export class BanklessToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class BanklessToken extends ethereum.SmartContract {
  static bind(address: Address): BanklessToken {
    return new BanklessToken("BanklessToken", address);
  }
  ...
  checkpoints(
    param0: Address,
    param1: BigInt
  ): BanklessToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new BanklessToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<BanklessToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new BanklessToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
